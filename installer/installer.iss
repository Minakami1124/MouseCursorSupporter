...
[Run]
; No "skipifsilent" here on purpose: the app's own auto-update flow re-runs this installer
; with /VERYSILENT and relies on this entry to relaunch the new version afterward.
